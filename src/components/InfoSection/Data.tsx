...
export const homeObjOne = {
  ...
  alt: 'Ilustração campo verde com duas arvores três passarinhos e o sol avermelhado atrás.',
  dark: true,
  primary: true,
  darkText: true,
  bLink: 'contact'
...
export const homeObjTwo = {
  ...
  alt: 'Mulher de calças e top, um arbusto com uma marca de concluído na frente.',
  dark: true,
  primary: true,
  darkText: false,
  bLink: 'contact'
...
export const homeObjThree = {
  ...
  alt: 'Imagem que representa economia circular em 5 passos, 1 Resíduos orgânicos industriais e comercial, 2 compostagem in situ, solução fechada, 3 torre de compostagem, 4 composto orgânico, 5 jardins e hortas.',
  dark: true,
  primary: true,
  darkText: true,
  bLink: 'contact'
...
export const homeObjFour = {
  ...
  imgStart: false,
  img: '/images/time.svg',
  alt: 'Mulher sentada e um relógio para representar a compostagem acelerada.',
  dark: true,
  primary: true,
  darkText: true,
...
export const homeObjFive = {
  ...
  alt: 'Três quadros representando a separação de elementos no serviço de gravimetria.',
  dark: true,
  primary: true,
  darkText: false,
  bLink: "http://orcamento.organabiotech.com.br/orcamento",
...
export const homeObjSix = {
  ...
  alt: 'Homem e um quadro representando a apresentação de um treinamento.',
  dark: true,
  primary: true,
  darkText: true,
  bLink: "http://orcamento.organabiotech.com.br/orcamento",
...
export const homeObjEight = {
  ...
  alt: 'Homem e um quadro representando com mata verde representando a gestão de emissões de gases de efeito estufa.',
  dark: true,
  primary: true,
  darkText: true,
  bLink: "http://orcamento.organabiotech.com.br/orcamento",
...
export const homeObjNine = {
  ...
  alt: 'Homem e um quadro com gráfico verde representando a Projetos de Redução e/ou Compensação de Emissões.',
  dark: true,
  primary: true,
  darkText: false,
  bLink: "http://orcamento.organabiotech.com.br/orcamento",
...
export const homeObjTen = {
  ...
  alt: 'Homem e um quadro com um painel representando a apresentação de um evento.',
  dark: true,
  primary: true,
  darkText: true,
  bLink: "http://orcamento.organabiotech.com.br/orcamento",
